...
class ShippingAreaController extends Controller
{
    ...
    public function DivisionStore(Request $request){
        ...
        $notification = array(
            'message' => 'Регион добавлен успешно',
            'alert-type' => 'success'
        );
    ...
    public function DivisionUpdate(Request $request,$id){
        ...
        $notification = array(
            'message' => 'Регион обновлен успешно',
            'alert-type' => 'info'
        );
    ...
    public function StateStore(Request $request){
        ...
        $notification = array(
            'message' => 'Населенный пункт добавлен успешно ',
            'alert-type' => 'success'
        );
    ...
    public function StateUpdate(Request $request,$id){
        ...
        $notification = array(
            'message' => 'Населенный пункт обновлен успешно',
            'alert-type' => 'info'
        );
    ...
    public function StateDelete($id){
        ...
        $notification = array(
            'message' => 'Населенный пункт удален успешно',
            'alert-type' => 'info'
        );
