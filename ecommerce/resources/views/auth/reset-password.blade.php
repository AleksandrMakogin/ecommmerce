            ...
            <div class="sign-in-page">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 sign-in">
                        <h4 class="">Сбросить  пароль </h4>
                        <p class="">Вам необходимо придумать новій пароль </p>
                        ...
                        <form class="register-form outer-top-xs" role="form" method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-group">
                                <label class="info-title" for="password">Новый пароль<span>*</span></label>
                            ...
                            <button type="submit" class="btn-upper btn btn-primary checkout-page-button">Установить новый пароль </button>
                        </form>
                    </div>
                    <!-- Sign-in -->
