        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Список купонов <span class="badge badge-pill badge-danger"> {{ count($coupons) }} </span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                ...
                <div class="col-4">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Добавить купон </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('coupon.store') }}" >
                                    ...
                                    <div class="form-group">
                                        <h5>Имя купона   <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5>Скидка купона(%) <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5>Срок дейстаия купона   <span class="text-danger">*</span></h5>
                                        <div class="controls">
