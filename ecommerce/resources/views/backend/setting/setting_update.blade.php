        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Настройки страницы сайта </h4>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Лого Сайта   <span class="text-danger"> </span></h5>
                                                    <div class="controls">
                                                ...
                                                <div class="form-group">
                                                    <h5>Телефон офис <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                ...
                                                <div class="form-group">
                                                    <h5>Адрес компании  <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="text-xs-right">
                                            <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Обновить">
                                        </div>
                            </form>
