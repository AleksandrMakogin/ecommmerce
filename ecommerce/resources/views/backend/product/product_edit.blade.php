                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 1st row  -->
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Бренд <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 2nd row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Название продукта En<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_ru" class="form-control" required="" value="{{$products->product_name_ru}}">
                                        ...
                                        <div class="row"> <!-- start 3RD row  -->
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>Колличество <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>Ключовые cлова En <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 4th row  -->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>Ключовые cлова Ru <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_ru" class="form-control" value="{{$products->product_tags_ru}}" data-role="tagsinput" required="">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>Размер En <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>Размер Ru <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_size_ru" class="form-control" value="{{$products->product_size_ru}}" data-role="tagsinput" >
                                        ...
                                        <div class="row"> <!-- start 5th row  -->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>Цвет En <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Цвет Ru <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_color_ru" class="form-control" value="{{$products->product_color_ru}}" data-role="tagsinput" required="">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>Продажная цена <span class="text-danger">*</span></h5>
                                                    <div class="controls">
...
{{--                                                </div>--}}
                                        ...
                                        <div class="row"> <!-- start 7th row  -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="short_descp_ru" id="textarea" class="form-control" required placeholder="Textarea text">{!! $products->short_descp_ru !!}</textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                        </div> <!-- end 7th row  -->
                                        <div class="row"> <!-- start 8th row  -->
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Полное описание En <span class="text-danger">*</span></h5>
                                                    <div class="controls"><textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">{!!$products->long_descp_en !!}</textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Полное описание Ru <span class="text-danger">*</span></h5>
                                                    <div class="controls"><textarea id="editor2" name="long_descp_ru" rows="10" cols="80">{!!$products->long_descp_ru !!}</textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_2">Горячие предложения</label>
                                                        </fieldset>
                                                        <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_4">Cпециальное предложение</label>
                                                        </fieldset>
                                                        <fieldset>
                                        ...
                                        <div class="text-xs-right">
                                            <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Обновить продукт">
                                        </div>
                                    </div>
                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                        <div class="box-header">
                            <h4 class="box-title">Редактировать дополнительное фото продукта </h4>
                        </div>
                        ...
                        <form method="POST" action="{{ route('update-product-image') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                <div class="form-group">
                                                    <label class="form-control-label">Заменить фото <span class="tx-danger">*</span></label>
                            ...
                            <div class="text-xs-right m-4">
                                <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Обновить фото">
                            </div>
                            <br><br>
        ...
        <section class="content">
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <div class="box bt-3 border-info">
                        <div class="box-header">
                            <h4 class="box-title">Обновить главное фото</h4>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">
                                            <div class="form-group">
                                                <label class="form-control-label">Изменить фото <span class="tx-danger">*</span></label>
