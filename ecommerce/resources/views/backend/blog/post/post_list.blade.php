                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Список блог постов <span class="badge badge-pill badge-danger"> {{ count($blogpost) }} </span></h3>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>категория поста  </th>
                                        <th>Картинка поста </th>
                                        <th>Название поста En </th>
                                        <th>Название поста Ru </th>
                                        <th>Действия</th>
