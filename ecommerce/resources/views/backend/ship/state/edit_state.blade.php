                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('state.update',$state->id) }}" >
                                    ...
                                    <div class="form-group">
                                        <h5>Выбрать район <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <select name="district_id" class="form-control"  >
                                                <option value="" selected="" disabled="">Выбрать район</option>
                                    ...
                                    <div class="form-group">
                                        <h5>Назва населеного пун-та  <span class="text-danger">*</span></h5>
                                        <div class="controls">
