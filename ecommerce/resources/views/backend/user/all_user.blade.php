                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Пользователи <span class="badge badge-pill badge-danger"> {{ count($users) }} </span> </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                @if($user->UserOnline())
                                                    <span class="badge badge-pill badge-success">Активний сейчас</span>
                                                @else
