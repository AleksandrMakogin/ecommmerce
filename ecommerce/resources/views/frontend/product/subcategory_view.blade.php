...
{{--                                </div>--}}
                ...
                @foreach($breadsubcat as $item)
                    ...
                    <span class="badge badge-danger" style="background: #f8c52f">{{ $item->category->category_name_en }} </span>
                @endforeach
                /
                @foreach($breadsubcat as $item)
                    <span class="badge badge-warning" id="gradient1">{{ $item->subcategory_name_en }} </span>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}"><img height="220" src="{{ asset($product->product_thambnail) }}" alt=""></a> </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="product-list product">
                                                <div class="row product-list-row">
                                                    <div class="col col-sm-4 col-lg-4">
                                                        <div class="product-image">
                                                            <div class="image"> <img height="220" src="{{ asset($product->product_thambnail) }}" alt=""> </div>
                                                        </div>
                                                        <!-- /.product-image -->
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col col-sm-8 col-lg-8">
                                                        ...
                                                        <!-- /.product-price -->
                                                            <div class="description m-t-10">
                                                                @if(session()->get('language') == 'russian') {{ $product->short_descp_ru }} @else {{ $product->short_descp_en }} @endif</div>
