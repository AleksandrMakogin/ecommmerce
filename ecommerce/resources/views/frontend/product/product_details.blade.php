    ...
    <div class="body-content outer-top-xs">
        <div class='container'>
            <div class='row single-product'>
                ...
                <div class='col-md-9 '>
                    <div class="detail-block sidebar-widget">
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    ...
                                    <div class="description-container m-t-20">
                                        @if(session()->get('language') == 'russian') {{ $product->short_descp_ru }} @else {{ $product->short_descp_en }} @endif
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    @if ($product->discount_price == NULL)
                                                        <span class="price">${{ $product->selling_price }} UAH</span>
                                                    @else
                                                        <span class="price">{{ $product->discount_price }} UAH</span>
...
{{--                                    </div><!-- /.quantity-container -->--}}
                    ...
                    <div class="product-tabs inner-bottom-xs  wow fadeInUp sidebar-widget">
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="description" class="tab-pane in active">
                                        <div class="product-tab">
                                            <p class="text">@if(session()->get('language') == 'russian')
                                                    {!! $product->long_descp_ru !!} @else {!! $product->long_descp_en !!} @endif</p>
                                        </div>
                                    </div><!-- /.tab-pane -->
                                            ...
                                            <div class="review-form">
                                                @guest
                                                    <p> <b>
                                                                ...
                                                                Для добавления коментов Вам необходимо для начала Авторизироватся
                                                                @else
                                                                For Add Product Review. You Need to Login First
                                                                <a href="{{ route('login') }}">Login Here</a> </b> </p>
                                                                @endif
                                                @else
                                                        ...
                                                        <form role="form" class="cnt-form" method="post" action="{{ route('review.store') }}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="exampleInputSummary"> @if(session()->get('language') == 'russian')  Резюме отзыва @else  Summary @endif<span class="astk">*</span></label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputReview">  @if(session()->get('language') == 'russian') Отзыв  @else Review  @endif <span class="astk">*</span></label>
                                                            ...
                                                            <div class="action text-right">
                                                                <button type="submit" class="btn btn-primary btn-upper"> @if(session()->get('language') == 'russian') Подтвердить отзыв   @else  SUBMIT REVIEW @endif</button>
                                                            </div><!-- /.action -->
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}"><img style="height: 170px" src="{{ asset($product->product_thambnail) }}" alt=""></a>
                                            </div><!-- /.image -->
                                            @php
